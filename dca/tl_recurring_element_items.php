...
/**
 * Table tl_recurring_element_items
 */
$GLOBALS['TL_DCA']['tl_recurring_element_items'] = array
(
	...
	(
		'dataContainer'               => 'Table',
		'ptable'                      => 'tl_recurring_element',
		'switchToEdit'                => true,
		'enableVersioning'            => true,
		'onload_callback' => array
		(
			array('tl_recurring_element_items', 'checkPermission')
		),

		'onsubmit_callback' => array
		(
			array('tl_recurring_element_items', 'adjustTime'),
		),
		'sql' => array
		(
			'keys' => array
	...
	(
		...
		(
			'edit' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['edit'],
				'href'                => 'act=edit',
				'icon'                => 'edit.gif'
			),
			'copy' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['copy'],
				'href'                => 'act=paste&amp;mode=copy',
				'icon'                => 'copy.gif'
			),
			'cut' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['cut'],
				'href'                => 'act=paste&amp;mode=cut',
				'icon'                => 'cut.gif'
			),
			'delete' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['delete'],
				'href'                => 'act=delete',
				'icon'                => 'delete.gif',
			...
			'toggle' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['toggle'],
				'icon'                => 'visible.gif',
				'attributes'          => 'onclick="Backend.getScrollOffset();return AjaxRequest.toggleVisibility(this,%s)"',
				'button_callback'     => array('tl_recurring_element_items', 'toggleIcon')
			),
			'show' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['show'],
				'href'                => 'act=show',
				'icon'                => 'show.gif'
			)
		)
	...
	(
		...
		'addImageSettings'            => 'singleSRC,alt,size,imagemargin,imageUrl,fullsize,caption,floating',
	...
	(
		...
		'pid' => array
		(
			'foreignKey'              => 'tl_recurring_element.title',
		...
		'title' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['title'],
			'exclude'                 => true,
			'search'                  => true,
			'sorting'                 => true,
			'flag'                    => 1,
		...
		'author' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['author'],
		...
		'addTime' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['addTime'],
			'exclude'                 => true,
			'inputType'               => 'checkbox',
		...
		'startTime' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['startTime'],
			'default'                 => time(),
			'exclude'                 => true,
			'filter'                  => true,
			'sorting'                 => true,
		...
		'endTime' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['endTime'],
			'default'                 => time(),
			'exclude'                 => true,
			'inputType'               => 'text',
			...
			'save_callback' => array
			(
				array('tl_recurring_element_items', 'setEmptyEndTime')
			),
			'sql'                     => "int(10) unsigned NULL"
		),
		'startDate' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['startDate'],
			'default'                 => time(),
			'exclude'                 => true,
			'inputType'               => 'text',
		...
		'endDate' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['endDate'],
			'default'                 => null,
			'exclude'                 => true,
			'inputType'               => 'text',
			...
			'save_callback' => array
			(
				array('tl_recurring_element_items', 'setEmptyEndDate')
			),
			'sql'                     => "int(10) unsigned NULL"
		),
		'addText' => array
		...
		'headline' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['headline'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'inputUnit',
		...
		'addImageSettings' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['addImageSettings'],
			'exclude'                 => true,
			'inputType'               => 'checkbox',
			'eval'                    => array('submitOnChange'=>true),
			'sql'                     => "char(1) NOT NULL default ''"
		...
		(
			...
			'wizard' => array
			(
				array('tl_recurring_element_items', 'pagePicker')
			),
			'sql'                     => "varchar(255) NOT NULL default ''"
		),
		'fullsize' => array
		...
		'recurring' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['recurring'],
			'exclude'                 => true,
			'filter'                  => true,
			'inputType'               => 'checkbox',
			'eval'                    => array('submitOnChange'=>true),
		...
		'repeatEach' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['repeatEach'],
			'exclude'                 => true,
			...
			'save_callback' => array
			(
				array('tl_recurring_element_items', 'checkInterval')
			),
			'sql'                     => "varchar(64) NOT NULL default ''"
		),
		'repeatEnd' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['repeatEnd'],
			'sql'                     => "int(10) unsigned NOT NULL default '0'"
		),
		'recurrences' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['recurrences'],
			'exclude'                 => true,
			'inputType'               => 'text',
			'eval'                    => array('mandatory'=>true, 'rgxp'=>'digit', 'tl_class'=>'w50'),
		...
		'addEnclosure' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['addEnclosure'],
			'exclude'                 => true,
			'inputType'               => 'checkbox',
			'eval'                    => array('submitOnChange'=>true),
			'sql'                     => "char(1) NOT NULL default ''"
		...
		'priority' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['priority'],
			'exclude'                 => true,
			'inputType'               => 'text',
			'eval'                    => array('mandatory'=>true, 'rgxp'=>'digit', 'tl_class'=>'w50'),
			'sql'                     => "smallint(5) unsigned NOT NULL default '0'"
		...
		'cssClass' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['cssClass'],
			'exclude'                 => true,
			'inputType'               => 'text',
		...
		'published' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_recurring_element_items']['published'],
			'exclude'                 => true,
			'filter'                  => true,
			'flag'                    => 2,
			'inputType'               => 'checkbox',
...
/**
 * Class tl_recurring_element_items
 *
 ...
 */
class tl_recurring_element_items extends Backend
{
	...
	/**
	 * Check permissions to edit table tl_recurring_element_items
	 */
	public function checkPermission()
	{
		...
		{
			$key = array_search('allowComments', $GLOBALS['TL_DCA']['tl_recurring_element_items']['list']['sorting']['headerFields']);
			unset($GLOBALS['TL_DCA']['tl_recurring_element_items']['list']['sorting']['headerFields'][$key]);
		}
		...
		switch (Input::get('act'))
		{
			...
			case 'create':
				...
				{
					$this->log('Not enough permissions to create item in recurring_element ID "'.Input::get('pid').'"', __METHOD__, TL_ERROR);
			...
			case 'copy':
				...
				{
					$this->log('Not enough permissions to '.Input::get('act').' item ID "'.$id.'" to recurring_element ID "'.Input::get('pid').'"', __METHOD__, TL_ERROR);
					$this->redirect('contao/main.php?act=error');
				}
			...
			case 'delete':
			case 'toggle':
				$objCalendar = $this->Database->prepare("SELECT pid FROM tl_recurring_element_items WHERE id=?")
											  ->limit(1)
											  ->execute($id);
				...
				{
					$this->log('Not enough permissions to '.Input::get('act').' item ID "'.$id.'" of recurring_element ID "'.$objCalendar->pid.'"', __METHOD__, TL_ERROR);
					$this->redirect('contao/main.php?act=error');
				}
				break;
			...
			case 'copyAll':
				if (!in_array($id, $root))
				{
					$this->log('Not enough permissions to access recurring_element ID "'.$id.'"', __METHOD__, TL_ERROR);
					$this->redirect('contao/main.php?act=error');
				}

				$objCalendar = $this->Database->prepare("SELECT id FROM tl_recurring_element_items WHERE pid=?")
											  ->execute($id);

				if ($objCalendar->numRows < 1)
				{
					$this->log('Invalid recurring_element ID "'.$id.'"', __METHOD__, TL_ERROR);
					$this->redirect('contao/main.php?act=error');
				}
	...
	public function generateAlias($varValue, DataContainer $dc)
	{
		...
		$objAlias = $this->Database->prepare("SELECT id FROM tl_recurring_element_items WHERE alias=?")
								   ->execute($varValue);
	...
	public function getSourceOptions(DataContainer $dc)
	{
		...
		if ($this->User->hasAccess('tl_recurring_element_items::jumpTo', 'alexf'))
		{
			$arrOptions[] = 'internal';
		}

		// Add the "article" option
		if ($this->User->hasAccess('tl_recurring_element_items::articleId', 'alexf'))
		{
			$arrOptions[] = 'article';
		}

		// Add the "external" option
		if ($this->User->hasAccess('tl_recurring_element_items::url', 'alexf') && $this->User->hasAccess('tl_recurring_element_items::target', 'alexf'))
		{
			$arrOptions[] = 'external';
		}
	...
	public function adjustTime(DataContainer $dc)
	{
		...
		$this->Database->prepare("UPDATE tl_recurring_element_items %s WHERE id=?")->set($arrSet)->execute($dc->id);
	}
	...
	public function toggleIcon($row, $href, $label, $title, $icon, $attributes)
	{
		...
		if (!$this->User->hasAccess('tl_recurring_element_items::published', 'alexf'))
		{
			return '';
		}
	...
	public function toggleVisibility($intId, $blnVisible)
	{
		...
		$objVersions = new Versions('tl_recurring_element_items', $intId);
		$objVersions->initialize();

		// Trigger the save_callback
		if (is_array($GLOBALS['TL_DCA']['tl_recurring_element_items']['fields']['published']['save_callback']))
		{
			foreach ($GLOBALS['TL_DCA']['tl_recurring_element_items']['fields']['published']['save_callback'] as $callback)
			{
		...
		// Update the database
		$this->Database->prepare("UPDATE tl_recurring_element_items SET tstamp=". time() .", published='" . ($blnVisible ? 1 : '') . "' WHERE id=?")
					   ->execute($intId);

		$objVersions->create();
		$this->log('A new version of record "tl_recurring_element_items.id='.$intId.'" has been created'.$this->getParentEntries('tl_recurring_element_items', $intId), __METHOD__, TL_GENERAL);
